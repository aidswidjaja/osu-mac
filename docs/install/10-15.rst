...
- **osu! forum thread:** `https://osu.ppy.sh/community/forums/topics/1106057?start=7560723 <https://osu.ppy.sh/community/forums/topics/1106057?start=7560723>`_
- **Mega.NZ (468MB):** `https://mega.nz/file/... <https://mega.nz/file/54sgCaJB#nzuV4BNcOx7sJ-zx8elWwO9qgQCrHK763mIrTYyozZU>`_
...
- **Mega.nz download link (7.61MB):** `https://mega.nz/... <https://mega.nz/file/Fw9UmIbK#tzI4XDO1aoDuDiQ35V1sy8XDWlB5p_0O2ovCBbo9feo>`_
...
.. tip:: 
    ...
    where ``administrator`` is the name of your system's admin account. When the ``Password:`` prompt appears, enter your password for ``administrator`` (or whatever your admin account is). Then try running the Terminal command in Option B again (or to do this automatically, type ``sudo !!``).
